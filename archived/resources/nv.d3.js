...
nv.models.pieChart = function(to_show) {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
    ...
    ;
     ...
     if (to_show == 'followers') {
      var tooltip = function(key, y, e, graph) {
        ...
        return '<h3>'+y+' users have around '+key+' followers</h3>'
               //'<p>' +  y + ' followers</p>'
      }
    }
    else if (to_show == 'following') {
      var tooltip = function(key, y, e, graph) {
      
        return '<h3>'+y+' users follow around '+key+' users</h3>'
               //'<p>' +  y + ' followings</p>'
      }
    }
    else if (to_show == 'count') {
      var tooltip = function(key, y, e, graph) {
      
        return '<h3>'+y+' users have around '+key+' images</h3>'
               //'<p>' +  y + ' images</p>'
      }
    }
  ...
  var showTooltip = function(e, offsetElement) {
	...
	x = pie.valueFormat()(pie.x()(e.point)),
